...
export default function ChatPage() {
  return (
    <div className="h-full grid grid-cols-1 lg:grid-cols-5 gap-6 p-6" data-testid="chat-page">
      <div className="lg:col-span-3 flex flex-col h-full">
        ...
        <div className="flex-1 bg-khata-surface border-[3px] border-khata-border overflow-hidden flex flex-col">
          <ChatInterface />
        </div>
      </div>
